                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="password-confirm" type="password" class="form-control"
                                        @error('confirm_password') password is not match @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @error('phone') invalid number @enderror name="phone" required>
                            ...
                            <div class="row mb-3">
                                <label for="pincode"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Pincode') }}</label>
