...
@section('content')
    ...
    <div class="card-body">
        ...
        <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col">
                    <label for="status">{{ trans('product_trans.is_showing') }}</label>
                    <div class="input-group mb-3">
                ...
                <div class="col">
                    <label for="trend">{{ trans('product_trans.popular') }}</label>
                    <div class="input-group mb-3 col">
            ...
            <button type="submit" class="btn btn-outline-primary">{{ trans('product_trans.save') }}</button>
        </form>
    </div>
@endsection
