        ...
        <form action="{{route('categories.update',$category->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="input-group mb-3 col">
                        <img src="{{ asset('uploads/' . $category->image) }}" alt="" style=" max-width: 70px; max-height: 70px;">
            ...
            <div class="row">
                ...
                <div class="col">
                    <label for="is_popular">{{trans('category_trans.popular')}}</label>
                    <div class="input-group mb-3 col">
                        <input type="checkbox" class="" id="is_popular" name="is_populer" {{ ($category->is_populer == 1 ? 'checked' : '') }}>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <button type="submit" class="btn btn-outline-primary">{{trans('category_trans.save')}}</button>
        </form>
    </div>
@endsection
